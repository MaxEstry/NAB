...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    [Tooltip("Gets the provider-level data privacy consent status of the specified ad network.")]
    public class Advertising_GetAdNetworkDataPrivacyConsent : FsmStateAction
    {
        [Tooltip("The ad network to read consent status.")]
        ...
        [Tooltip("The resulted data privacy consent.")]
        ...
        void DoMyAction()
        {
            var consent = Advertising.GetDataPrivacyConsent((AdNetwork)adNetwork.Value);
