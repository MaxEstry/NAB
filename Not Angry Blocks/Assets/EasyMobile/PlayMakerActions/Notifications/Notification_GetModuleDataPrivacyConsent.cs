...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    [Tooltip("Gets the module-level data privacy consent status of the Notifications module.")]
    public class Notification_GetModuleDataPrivacyConsent : FsmStateAction
    {
        ...
        void DoMyAction()
        {
            var consent = Notifications.DataPrivacyConsent;
