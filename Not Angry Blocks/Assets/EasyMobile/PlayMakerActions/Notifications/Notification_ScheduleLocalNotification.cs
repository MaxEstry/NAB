...
namespace EasyMobile.PlayMaker.Actions
{
    ...
    [Tooltip("Schedules a local notification to be posted at the specified time with no repeat."
    ...
    public class Notification_ScheduleLocalNotification : FsmStateAction
    {
        ...
        [Tooltip("delay hours")]
        public FsmInt delayHours;

        [Tooltip("delay minutes")]
        public FsmInt delayMinutes;

        [Tooltip("delay seconds")]
        public FsmInt delaySeconds;
        ...
        void DoMyAction()
        {
            ...
            {
                TimeSpan spanDelay = new TimeSpan(delayHours.Value, delayMinutes.Value, delaySeconds.Value);
                ...
                id = Notifications.ScheduleLocalNotification(spanDelay, content);
                Finish();
            }
        }
    }
