...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    [Tooltip("Determines whether the Notification module of Easy Mobile is enabled.")]
    public class Notification_IsModuleEnabled : FsmStateAction
    {
        ...
        void DoMyAction()
        {
            isEnabled = EM_Settings.IsNotificationsModuleEnable;
