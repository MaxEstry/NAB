...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    [Tooltip("Waits until a local notification is opened," +
    ...
    public class Notification_OnLocalNotificationOpened : FsmStateAction
    {
        ...
        [Tooltip("Event sent when a local notification is opened.")]
        ...
        {
            Notifications.LocalNotificationOpened += OnNotificationOpened;
        }
        ...
        void OnNotificationOpened(LocalNotification notif)
        {
