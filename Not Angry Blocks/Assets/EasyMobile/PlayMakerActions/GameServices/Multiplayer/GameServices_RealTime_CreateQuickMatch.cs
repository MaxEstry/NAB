...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    public class GameServices_RealTime_CreateQuickMatch : FsmStateAction
    {
        ...
        public override void OnEnter()
        {
            ...
            GameServices.RealTime.CreateQuickMatch(Req, listener.Value.GetComponent<IRealTimeMultiplayerListener>());
            Finish();
        }
