...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    [Tooltip("Determines whether the Game Service module of Easy Mobile is enabled.")]
    public class GameService_IsModuleEnabled : FsmStateAction
    {
        ...
        void DoMyAction()
        {
            isEnabled = EM_Settings.IsGameServicesModuleEnable;
